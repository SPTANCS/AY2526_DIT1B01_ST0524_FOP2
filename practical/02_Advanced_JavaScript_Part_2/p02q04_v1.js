  ...
  */
  ...
  return {
    greetStudent() {
      ...
      Hi, <studName>
      */
      return `Hi! ${studentArr[studentIndex].studName}`
    },
    ...
    greetwSalutation() {
      ...
      */
      if (studentArr[studentIndex].sex == 'M') {
        return `Hi, Mr. ${studentArr[studentIndex].studName}.`;
      } else if (studentArr[studentIndex].sex == 'F') {
        return `Hi, Ms. ${studentArr[studentIndex].studName}.`;
      } else {
        return `Hi, ${studentArr[studentIndex].studName}.`;
      }
    },
    greetwTimeofDay() {
      ...
      */
      ...
      return `${result} ${studentArr[studentIndex].studName}`;
    },
    yourGPA() {
      /* TODO : Add Code Here 
         Part f. 
         ...
         Your GPA is <studGPA>
      */
      return `Your GPA is ${studentArr[studentIndex].studGPA}\n` +
